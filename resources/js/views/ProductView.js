...
class ProductView extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (
            nextProps.match.params.product !== this.props.match.params.product
        ) {
    ...
    render() {
        ...
        products
            ? (outputRecommendedProducts = (
                  <OurRecommendations products={products} />
              ))
        ...
        if (product) {
            ...
            productOutput = (
                <div className="w-full my-px">
                    <p className="capitalize text-lg text-gray-darkest">
                        {product.name}
                    </p>
                    ...
                    <div className="flex mb-4 pt-2">
                        ...
                        <div className="w-5/12 px-2">
                            ...
                            <p className="text-sm text-gray-darker my-2">
                                Item number {product.uuid}
                            </p>
                            <p className="py-2">
                            ...
                            <p className="py-2 text-sm">
                                You save:{" "}
                                <span className="text-red font-semibold">{`${product.discount}%`}</span>
                            </p>
                            <p className="py-2 text-sm">
                                Including VAT{" "}
                            ...
                            <p className="py-4 text-sm text-black underline">
                                Size chart
                            </p>

                            <div className="flex">
                                <SizeSelector
                                    selectOnChange={this.handleSizeChange}
                                />

                                <QuantitySelector
                                    selectOnChange={this.handleQtyChange}
                                />
                            </div>
                            ...
                            <div className="flex mt-8">
                                ...
                                />
                                <button className="bg-transparent hover:bg-gray-light text-black py-2 px-4 border border-black">
                                    <FontAwesomeIcon
                                        icon={faHeart}
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchProductBySlug: slug =>
            dispatch(actions.fetchProductBySlug(slug)),
